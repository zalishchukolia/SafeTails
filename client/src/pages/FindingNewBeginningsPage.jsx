  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 22 }}>
        <h3 style={{ color: "#fff", fontSize: 22, margin: "0 0 10px" }}>
          {title}
        </h3>
        <p
          style={{
...
function TeamCard({ name, role }) {
  return (
    ...
    >
      ...
      <div style={{ color: "#8a8a8a", fontSize: 13, lineHeight: 1.7 }}>
        {role}
      </div>
    </div>
  );
...
function Footer() {
  return (
    ...
    >
      <div
        style={{ maxWidth: 1320, margin: "0 auto", padding: "42px 40px 26px" }}
      >
        <div
        ...
        >
          <div>
            ...
            >
              Допомагаємо тваринам знайти безпеку, турботу та новий дім. Разом
              ми можемо змінити їхнє майбутнє.
            </p>
          </div>
          <FooterColumn
            title="НАВІГАЦІЯ"
            links={["Панель", "Тварини", "Відправка"]}
          />
          <FooterColumn
            title="ДОПОМОГА"
            links={["Прихисток", "Медична карта", "Архів"]}
          />
          <FooterColumn
            title="ПІДТРИМКА"
            links={["Довідка", "Донат", "Волонтерство"]}
          />
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <span style={{ fontSize: 14, color: "#4d4d4d", cursor: "pointer" }}>
              ↗
            </span>
            <span style={{ fontSize: 14, color: "#4d4d4d", cursor: "pointer" }}>
              ✦
...
export default function FindingNewBeginningsPage() {
  ...
  const isInvalid = (field) =>
    touched && requiredFields.includes(field) && !form[field].trim();
        ...
        >
          ...
          <section style={{ padding: "18px 0 58px" }}>
            ...
            >
              <div>
                ...
                >
                  SafeTails — місцева ініціатива зі Львова, Україна. Ми
                  об'єднуємо волонтерів, прийомні сім'ї та небайдужих людей, які
                  хочуть допомогти врятованим тваринам одужати та розпочати нове
                  життя.
                </p>
                <div
                  style={{
              ...
              >
                ...
                >
                  ...
                  >
                    Кожен волонтер, прийомна сім'я та небайдуже повідомлення
                    важливі. Навіть одна маленька дія може змінити майбутнє
                    тварини.
                  </p>
                </div>
              </div>
          ...
          <section id="volunteer-form" style={{ padding: "10px 0 70px" }}>
            ...
            >
              ...
              >
                ...
                >
                  Ми шукаємо людей, які хочуть допомагати тваринам через
                  турботу, прийомний догляд, транспортування та комунікацію.
                  Заповни форму та розкажи, як хочеш долучитися.
                </p>
                <div style={{ display: "grid", gap: 12 }}>
                  {[
                    [
                      "Волонтер",
                      "Підтримка щоденної роботи, комунікації та координації.",
                    ],
                    [
                      "Прийомна сім'я",
                      "Тимчасовий догляд за твариною перед тим, як вона знайде дім.",
                    ],
                    [
                      "Транспорт",
                      "Допомога з перевезенням тварин або припасів за потреби.",
                    ],
                    [
                      "Інша допомога",
                      "Долучайся з будь-якими навичками або підтримкою.",
                    ],
                  ].map(([title, text]) => (
                    <div
                      key={title}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    background: loading
                      ? "#555"
                      : "linear-gradient(90deg,#ff6b2b,#ff4500)",
                    color: "#fff",
                    border: "none",
                    borderRadius: 18,
                    padding: "15px 18px",
          ...
          <section id="stories" style={{ padding: "10px 0 70px" }}>
            ...
            <div style={{ marginBottom: 22 }}>
              ...
              >
                Порятунок — це не лише про надзвичайні ситуації. Це також про
                зцілення, терпіння, довіру та людей, які допомагають тваринам
                перейти від страху до безпеки.
              </p>
            </div>
            <div
                ...
                rescuedAnimals.map((animal, i) => (
                  ...
                  >
                    ...
                    <div style={{ padding: 22 }}>
                      ...
                      >
                        {animal.description ||
                          "Тварина знайшла безпечний дім завдяки нашим волонтерам."}
                      </p>
                      <div
                        style={{
                          display: "inline-flex",
          ...
          <section id="about-team" style={{ padding: "10px 0 84px" }}>
            ...
            >
              ...
              >
                ...
                >
                  SafeTails — ініціатива з порятунку тварин, що базується у
                  Львові, Україна. Ми допомагаємо тваринам через підтримку,
                  догляд, можливості прийомних сімей та пошук безпечних домівок.
                </p>
                <p
                  style={{
                    color: "#8b8b8b",
                ...
                >
                  Наша команда невелика, але ми глибоко переймаємося створенням
                  кращого майбутнього для тварин, яким потрібна допомога.
                </p>
                <div
                  className="double-grid"
                  style={{
                ...
                >
                  {[
                    [
                      "Місія",
                      "Рятувати, доглядати та знаходити дім для тварин",
                    ],
                    [
                      "Напрямок",
                      "Підтримка, прийомні сім'ї та безпечний прихисток",
                    ],
              ...
              >
                ...
                >
                  Якщо ви хочете стати волонтером, підтримати проєкт або
                  дізнатися про прийомний догляд — зв'яжіться з нами напряму.
                </p>
