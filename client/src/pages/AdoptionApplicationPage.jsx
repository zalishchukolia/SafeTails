    ...
    >
      <div style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          >
            Заповніть форму нижче, і ми розглянемо вашу заявку, щоб знайти
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <Field label="Ім'я тварини *">
              <input
                ...
                onChange={handleChange}
                placeholder="Яку тварину хочете прихистити?"
              />
            </Field>
            ...
            <Field label="Чому ви хочете дати прихисток цій тварині?">
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                placeholder="Коротко розкажіть про себе та чому хочете подарувати дім цій тварині..."
                style={{ resize: 'none' }}
              />
            </Field>
            ...
            <button
              ...
              style={{
                width: '100%',
                background: sending ? '#a14a24' : '#ff6b2b',
                border: 'none',
                borderRadius: 12,
                padding: '16px',
                color: '#fff',
              ...
              onMouseEnter={e => {
                if (!sending) e.currentTarget.style.background = '#e55a1f'
              }}
              onMouseLeave={e => {
                if (!sending) e.currentTarget.style.background = '#ff6b2b'
              }}
            >
